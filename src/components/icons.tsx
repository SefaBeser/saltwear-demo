...
export function IconHeart(props: React.SVGProps<SVGSVGElement> & { filled?: boolean }) {
  ...
  return (
    <svg viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="1.5" aria-hidden {...rest}>
